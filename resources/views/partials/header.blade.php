<header class="navbar navbar-fixed-top navbar-shadow">
    <div class="navbar-branding">
        <a class="navbar-brand" href="dashboard.html">
            <b>{!! config('adm.logo') !!}</b>-{!! config('adm.logo-mini') !!}
        </a>
                            ...
                            <div class="tab-content br-n pn">
                                ...
                                <div id="nav-tab2" class="tab-pane chat-widget" role="tabpanel">
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#">
                                                <img class="media-object" alt="64x64" src="{{ asset('theme/assets/img/avatars/3.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-right">
                                            <a href="#">
                                                <img class="media-object" alt="64x64" src="{{ asset('theme/assets/img/avatars/1.jpg') }}">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#">
                                                <img class="media-object" alt="64x64" src="{{ asset('theme/assets/img/avatars/2.jpg') }}">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                            <span class="media-status online"></span>
                                ...
                                <div id="nav-tab3" class="tab-pane scroller-nm" role="tabpanel">
                                    <ul class="media-list" role="menu">
                                        <li class="media">
                                            <a class="media-left" href="#"> <img src="{{ asset('theme/assets/img/avatars/5.jpg') }}" class="mw40" alt="avatar"> </a>
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            <a class="media-left" href="#"> <img src="{{ asset('theme/assets/img/avatars/2.jpg') }}" class="mw40" alt="avatar"> </a>
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            <a class="media-left" href="#"> <img src="{{ asset('theme/assets/img/avatars/3.jpg') }}" class="mw40" alt="avatar"> </a>
                                            <div class="media-body">
                                                <h5 class="media-heading">Article
                                                    <small class="text-muted">- 08/16/22</small>
                                                </h5> Last Updated 36 days ago by
                                        ...
                                        <li class="media">
                                            <a class="media-left" href="#"> <img src="{{ asset('theme/assets/img/avatars/4.jpg') }}" class="mw40" alt="avatar"> </a>
                                            <div class="media-body">
                                                <h5 class="media-heading mv5">Article
                                                    <small class="text-muted">- 08/16/22</small>
                                                </h5> Last Updated 36 days ago by
